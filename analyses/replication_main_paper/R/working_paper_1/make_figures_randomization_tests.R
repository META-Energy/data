...
source("/Users/franzprante/GitHub/MORPEP/META_CMP/data/analysis/R/run_randomization_test.R")
source("/Users/franzprante/GitHub/MORPEP/META_CMP/data/analysis/R/randomization_test_battery.R")
source("/Users/franzprante/GitHub/MORPEP/META_CMP/data/analysis/R/format_randomization_table.R")
source("/Users/franzprante/GitHub/MORPEP/META_CMP/data/analysis/R/plot_randomization_tests.R")
...
table_random_test_90_all <- format_randomization_table(random_test_90_all,
...
#### Save figure as pdf 
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_90_all.pdf"), 
...
#### Format and save table
table_random_test_95_all <- format_randomization_table(random_test_95_all,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_95_all.pdf"), 
...
#### Format and save table
table_random_test_99_all <- format_randomization_table(random_test_99_all,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_99_all.pdf"),
...
#### Format and save table
table_random_test_90_sr <- format_randomization_table(random_test_90_sr,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_90_sr.pdf"), 
...
#### Format and save table
table_random_test_95_sr <- format_randomization_table(random_test_95_sr,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_95_sr.pdf"), 
...
#### Format and save table
table_random_test_99_sr <- format_randomization_table(random_test_99_sr,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_99_sr.pdf"), 
...
random_test_90_lr <- randomization_test_battery(
  data = d_neg_z %>% filter(horizond == 2),
  statistic = "z_stat",
  thresholds = c(1.645), # 90 % level 
  group = NULL,
  deltas = deltas
...
#### Format and save table
table_random_test_90_lr <- format_randomization_table(random_test_90_lr,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_90_lr.pdf"), 
...
#### Format and save table
table_random_test_95_lr <- format_randomization_table(random_test_95_lr,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_95_lr.pdf"), 
...
#### Format and save table
table_random_test_99_lr <- format_randomization_table(random_test_99_lr,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_99_lr.pdf"), 
...
#### Format and save table
table_random_test_90_top <- format_randomization_table(random_test_90_top,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_90_top.pdf"), 
...
#### Format and save table
table_random_test_95_top <- format_randomization_table(random_test_95_top,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_95_top.pdf"), 
...
#### Format and save table
table_random_test_99_top <- format_randomization_table(random_test_99_top,
                                                   group_comparison = NULL,
                                                   group_order = NULL)
#### Visualize
...
#### Save figure as pdf
ggsave(paste0(figure_path, "randomization_tests/", "figure_random_test_99_top.pdf"), 
