...
source(
  "/Users/franzprante/GitHub/MORPEP/META_Energy/data/analyses/replication_main_paper/R/calibrate_counterfactual.R"
)
source(
...
### Figure B.1 - Brodeur et. al. 2020 calibration of counterfactual ----
#### Create 1x2 plot for joint plot
par(mfrow = c(1, 2))
#### Short run ----
# Calibrate
